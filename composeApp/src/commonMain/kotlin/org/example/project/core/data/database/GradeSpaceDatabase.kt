...
import org.example.project.core.data.database.dao.FeedDao
import org.example.project.core.data.database.dao.ProfileDao
import org.example.project.core.data.database.dao.TasksDao
import org.example.project.core.data.database.entities.feed.FeedEventEntity

@Database(
    entities = [FeedEventEntity::class],
    version = 1
)
@TypeConverters(
